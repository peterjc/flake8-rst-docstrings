...
Sadly docutils considers all three examples to be invalid:
    ...
    RST307/code_invalid_arg.py:13:1: RST307 Error in "code" directive: unknown option: "wibble".
    RST307/code_invalid_arg.py:22:1: RST307 Error in "code-block" directive: unknown option: "caption".
    RST307/code_invalid_arg.py:30:1: RST307 Error in "code-block" directive: unknown option: "dedent".
